      ...
      <section style={{
        ...
        <motion.div style={{ y: heroY, maxWidth: 900, position: 'relative', zIndex: 1 }}>
          ...
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}
            ...
            The Vedic Astrology API
            <br />
            <span className="gradient-text">for Modern Developers</span>
          </motion.h1>
  ...
  `}<span style={{color:'#a78bfa'}}>-d</span>{` `}<span style={{color:'#fbbf24'}}>{'{"dateOfBirth":"1990-05-15","timeOfBirth":"14:30","latitude":28.6139,"longitude":77.2090,"timezone":"Asia/Kolkata"}'}</span>{``}</code>
      ...
      <section className="section" style={{ background: 'var(--bg-secondary)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 32, maxWidth: 1000, margin: '0 auto' }}>
          {[
            { n: '01', title: 'Sign Up & Get Key', desc: 'Create a free account. You instantly get an API key with 100 requests/day \u2014 no credit card.', icon: Key },
        ...
        <FadeIn delay={0.15}>
          <div style={{ overflowX: 'auto', maxWidth: 1000, margin: '0 auto' }}>
            <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: 0, fontSize: 14 }}>
              ...
              <tbody>
                {[
                  { f: 'Free Tier', a: '100 req/day', b: 'Limited trial', c: '50 req/day', d: 'Paid only' },
      ...
      <section className="section" style={{ background: 'var(--bg-secondary)' }}>
        <FadeIn>
          <p style={{ textAlign: 'center', color: '#64748b', fontSize: 13, textTransform: 'uppercase', letterSpacing: 2.5, marginBottom: 12, fontWeight: 600 }}>Pricing</p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24, maxWidth: 960, margin: '0 auto' }}>
          {[
            { name: 'Free', price: '$0', period: '/forever', limit: '100 requests/day', color: '#64748b', features: ['All 180+ endpoints', 'Birth charts & predictions', 'Divisional charts', 'AI chat (BYO key)', 'Community support'], cta: 'Get Started', highlight: false },
            { name: 'Pro', price: '$29', period: '/month', limit: '10,000 requests/day', color: '#7c3aed', features: ['Everything in Free', 'PDF report generation', 'Priority rate limits', 'Admin panel access', 'Email support'], cta: 'Start Pro Trial', highlight: true },
            { name: 'Enterprise', price: 'Custom', period: '', limit: 'Unlimited requests', color: '#f59e0b', features: ['Everything in Pro', 'Dedicated infrastructure', 'Custom SLA', 'Phone support', 'On-premise deployment'], cta: 'Contact Sales', highlight: false },
          ].map((p, i) => (
            <FadeIn key={p.name} delay={i * 0.1}>
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginBottom: 8 }}>
                  ...
                  {p.period && <span style={{ color: '#64748b', fontSize: 15 }}>{p.period}</span>}
                </div>
      ...
      <section className="section" style={{ textAlign: 'center' }}>
        <FadeIn>
          ...
          <p style={{ color: '#94a3b8', fontSize: 18, maxWidth: 500, margin: '0 auto 40px', lineHeight: 1.7 }}>
            No credit card required. 100 free requests per day. Full access to all endpoints.
          </p>

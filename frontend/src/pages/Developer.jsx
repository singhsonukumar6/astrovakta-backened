...
const TERMINAL_LINES = [
  ...
  { text: 'curl', color: '#4f46e5' },
  { text: ' ', color: '' },
  { text: '-X POST', color: '#16a34a' },
  { text: ' ', color: '' },
  { text: '"https://api.astrovakta.com/api/kundli"', color: '#d97706' },
  { text: ' \\\n', color: '#64748b' },
  { text: '  ', color: '' },
  { text: '-H', color: '#4f46e5' },
  { text: ' ', color: '' },
  { text: '"X-API-Key: avk_live_xxx"', color: '#d97706' },
  { text: ' \\\n', color: '#64748b' },
  { text: '  ', color: '' },
  { text: '-d', color: '#4f46e5' },
  { text: ' ', color: '' },
  { text: '{"dateOfBirth":"1990-05-15","timeOfBirth":"14:30","latitude":28.6139,"longitude":77.2090,"timezone":"Asia/Kolkata"}', color: '#d97706' },
]
...
function TypingTerminal() {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}
      ...
      style={{
        marginTop: 56, background: '#ffffff', border: '1px solid rgba(124,58,237,0.2)',
      ...
      <pre style={{ padding: '20px 24px', fontSize: 13, lineHeight: 1.9, fontFamily: 'var(--font-mono)', color: '#1e293b', overflow: 'auto', textAlign: 'left', minHeight: 90 }}>
        <code>
          {built.map((seg, i) => (
            <span key={i} style={{ color: seg.color || undefined }}>{seg.text}</span>
          ))}
          <span style={{
            display: 'inline-block', width: 8, height: 18, background: '#16a34a',
    ...
    <div style={{ overflow: 'hidden' }}>
      ...
      <section style={{
        ...
        <motion.div style={{ y: heroY, maxWidth: 900, position: 'relative', zIndex: 1 }}>
          <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }}
            ...
            <Zap size={14} /> 216+ Endpoints {'\u00B7'} AI-Powered {'\u00B7'} Sidereal Engine
          </motion.div>
          ...
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}
            ...
            <span style={{ color: '#0f172a' }}>Astro</span>
            <span style={{ color: '#d97706' }}>Vakta</span>
            <motion.span
          ...
          <motion.h2 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            ...
            style={{
              ...
              color: '#475569', marginBottom: 16, lineHeight: 1.4,
            }}>
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            ...
            style={{
              fontSize: 'clamp(15px, 1.8vw, 18px)', color: '#475569',
              maxWidth: 640, margin: '0 auto 44px', lineHeight: 1.75,
            }}>
            Birth charts, horoscopes, doshas, compatibility, panchang, divisional charts, PDF reports, and AI interpretations \u2014 a complete sidereal astrology engine behind a single REST API.
          </motion.p>
      ...
      <section className="section" id="features">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24 }}>
          {[
            ...
            { icon: Moon, title: 'Daily Horoscopes', desc: 'Daily, weekly, monthly & yearly horoscopes generated from real-time transits over the natal chart.', color: '#2563eb' },
            { icon: Heart, title: 'Compatibility (Milan)', desc: 'Ashtakoot gun milan, Nadi dosha, Bhakoot dosha, and Gana matching for matrimonial analysis.', color: '#db2777' },
            ...
            { icon: Brain, title: 'AI Interpretations', desc: 'Bring your own OpenAI, Claude, Groq, or Together key. AI reads your chart context and gives natural-language predictions.', color: '#7c3aed' },
            { icon: Clock, title: 'Panchang & Muhurat', desc: 'Full Panchang \u2014 Tithi, Nakshatra, Yoga, Karana, Vara \u2014 plus auspicious muhurat windows for events.', color: '#d97706' },
            ...
            { icon: Lock, title: 'API Key Auth & Tiers', desc: 'AES-encrypted key storage, rate limiting by tier (Free / Starter / Pro / Enterprise), and usage analytics.', color: '#4f46e5' },
          ...
          {[
            ...
            <FadeIn key={showcase.title} delay={i * 0.12}>
              <motion.div
                ...
                <p style={{ color: '#475569', fontSize: 14, lineHeight: 1.7, marginBottom: 20 }}>{showcase.desc}</p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {showcase.items.map((item) => (
                    <div key={item} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, color: '#334155' }}>
          ...
          {[
            {
              ...
              color: '#64748b',
              features: ['All 216+ endpoints', 'Birth charts & predictions', 'Divisional charts', 'AI chat (BYO key)', 'Community support'],
            ...
            <FadeIn key={p.name} delay={i * 0.1}>
              <div style={{
                ...
                <p style={{ color: '#475569', fontSize: 13, marginBottom: 24 }}>{p.limit}</p>
                {p.cta === 'Contact Sales' ? (
                ...
                {p.features.map((feat) => (
                  <div key={feat} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '6px 0', fontSize: 13, color: '#334155' }}>
      ...
      <section className="section" id="custom-websites">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24, marginBottom: 48 }}>
          {[
            ...
            { icon: Server, title: 'Full API Integration', desc: 'All 216+ AstroVakta endpoints — birth charts, horoscopes, compatibility, doshas, AI, PDF reports.' },
            ...
            <FadeIn key={p.name} delay={i * 0.1}>
              <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 28, flex: 1 }}>
                  {p.features.map((f) => (
                    <div key={f} style={{ display: 'flex', alignItems: 'flex-start', gap: 10, fontSize: 13, color: '#334155', lineHeight: 1.5 }}>
      ...
      <section className="section" style={{ background: 'var(--bg-secondary)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 20, maxWidth: 1100, margin: '0 auto' }}>
          {[
            ...
            { cat: 'Predictions', items: ['Daily Horoscope', 'Weekly / Monthly', 'Yearly Forecast', 'Transit Analysis', 'Business Prediction', 'Education Prediction'], color: '#2563eb' },
            { cat: 'Timing', items: ['Vimshottari Dasha', 'Chara Dasha', 'Yogini Dasha', 'Panchang', 'Muhurat', 'Varshaphal'], color: '#d97706' },
            { cat: 'Analysis', items: ['Compatibility', 'Dosha Detection', 'Yoga Detection', 'Shadbala', 'Ashtakavarga', 'Numerology'], color: '#db2777' },
            { cat: 'AI & Reports', items: ['AI Chat', 'AI Interpretation', 'AI Horoscope Gen', 'PDF Reports', 'Gemstone Advisor', 'Career Analysis'], color: '#7c3aed' },
          ...
          {[
            ...
            <FadeIn key={i} delay={i * 0.12}>
              <div className="card-glow" style={{
                ...
                <p style={{ color: '#334155', fontSize: 15, lineHeight: 1.7, marginBottom: 20, fontStyle: 'italic' }}>"{t.quote}"</p>
            ...
            <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: 0, fontSize: 14 }}>
                ...
                <tr>
                  ...
                  {['AstroVakta', 'AstroYogi API', 'Prokerala', 'ClickAstro'].map((name, i) => (
                    <th key={name} style={{
                      ...
                      fontSize: i === 0 ? 15 : 14, color: i === 0 ? '#4f46e5' : '#475569',
              ...
              <tbody>
                {[
                  ...
                  { f: 'Total Endpoints', a: '216+', b: '~40', c: '~60', d: '~30' },
                  ...
                  <tr key={i} style={{ borderBottom: '1px solid rgba(124,58,237,0.08)' }}>
                    <td style={{ padding: '13px 20px', color: '#1e293b', fontWeight: 500, fontSize: 13 }}>{row.f}</td>
                    {[row.a, row.b, row.c, row.d].map((val, j) => (
                      <td key={j} style={{
                        ...
                        {val === true ? (
                          <span style={{ color: '#16a34a', fontWeight: 700 }}><Check size={16} style={{ display: 'inline' }} /></span>
                        ) : val === false ? (
      ...
      <section className="section">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 20, maxWidth: 1000, margin: '0 auto' }}>
          {[
            ...
            { icon: Cloud, name: 'PostgreSQL', desc: 'Reliable data persistence', color: '#2563eb' },
            { icon: Lock, name: 'AES-256', desc: 'API key encryption at rest', color: '#d97706' },
            { icon: Bot, name: 'Multi-AI', desc: 'OpenAI / Claude / Groq / Together', color: '#db2777' },
            { icon: FileText, name: 'ReportLab', desc: '22-section branded PDF reports', color: '#7c3aed' },
            ...
            <FadeIn key={stack.name} delay={i * 0.06}>
              <div style={{
                ...
                <p style={{ color: '#475569', fontSize: 12, lineHeight: 1.5 }}>{stack.desc}</p>
              </div>
            </FadeIn>
          ))}
        </div>
      ...
      <section className="section" style={{ background: 'var(--bg-secondary)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: 24, maxWidth: 1100, margin: '0 auto' }}>
          {[
            ...
            { icon: HeartHandshake, title: 'Matrimony Platforms', desc: 'Integrate kundali matching, guna milan, and dosha detection directly into your matrimonial website.', color: '#db2777' },
            ...
            { icon: GraduationCap, title: 'Research & Academia', desc: 'Access raw astrological data for research papers, statistical analysis, and educational platforms.', color: '#2563eb' },
            { icon: Building2, title: 'SaaS Platforms', desc: 'White-label our API into your SaaS product. Resell astrology services under your own brand with custom pricing.', color: '#d97706' },
          ].map((useCase, i) => (
            <FadeIn key={useCase.title} delay={i * 0.08}>
              <motion.div whileHover={{ y: -4 }} className="card-glow" style={{
                ...
                <p style={{ color: '#475569', fontSize: 14, lineHeight: 1.7 }}>{useCase.desc}</p>
              </motion.div>
            </FadeIn>
          ))}
        </div>
      ...
      <section className="section">
        ...
        <div style={{ maxWidth: 800, margin: '48px auto 0' }}>
          {[
            ...
            { q: 'What is the rate limit on the free tier?', a: 'The free tier includes 500 API calls per month with no credit card required. You get full access to all 216+ endpoints. Rate limiting is applied per API key, and you can monitor your usage from the dashboard at any time.' },
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: '#475569', fontSize: 14, lineHeight: 1.7 }}>{faq.a}</p>
                  </div>
                </div>
              </div>
            </FadeIn>
      ...
      <section className="section" style={{ textAlign: 'center' }}>
        <FadeIn>
          ...
          <p style={{ color: '#475569', fontSize: 18, maxWidth: 500, margin: '0 auto 40px', lineHeight: 1.7 }}>

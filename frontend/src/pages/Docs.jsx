...
\`\`\``,
  ...
  },
  {
    ...
    note: 'All endpoints support multi-language output. Add "lang":"hi" (or ta, te, kn, ml, bn, mr, gu, pa) to any request body. Also accepts Accept-Language header. Default: English.',
    endpoints: [
